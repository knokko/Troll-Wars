...
public class GuiTrading extends GuiBase {
	...
	protected SizedTexture inventoryTexture;
	...
	public void render(GuiRenderer renderer){
		...
		if(inventoryTexture != null)
			renderer.renderTextures(new Vector2f(-0.8f, 1 - inventoryTexture.getRelativeHeight()), new Vector2f(0.2f, inventoryTexture.getRelativeHeight()), inventoryTexture);
		if(selectedOfferTexture != null)
	...
	public void refreshCurrentTexture(){
		...
		inventoryTexture = Resources.createInventoryTexture(Game.getPlayerInventory(), offers.getUsefulItems(Game.getPlayerInventory().getItems()));
